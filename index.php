...
class Bootstrap {
	...
	public function init() {
        ...
        if ( ! empty( $test_name ) ) {
            ...
            if ( ! empty( $theme_mods ) ) {
                $bool_theme_mods = [ 'neve_advanced_layout_options', 'neve_blog_list_alternative_layout', 'neve_enable_card_style', 'neve_blog_separator', 'neve_global_header', 'neve_enable_payment_icons', 'neve_enable_product_breadcrumbs', 'neve_enable_product_navigation', 'neve_enable_cart_upsells' ];
